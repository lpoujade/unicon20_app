...
class Notifications {
  ...
  /// tap handler
  Future<void> show(String title, String? text, String payload,
      String? channel_slug, String? channel_name) async {
    ...
    await notifier.show(0, title, text, platformChannelSpecifics,
        payload: payload);
  }
}
